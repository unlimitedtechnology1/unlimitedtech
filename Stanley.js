...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = '255786996982';
            const dj2 = '255786996982';
            const dj3 = "255786996982";
            const luffy = '2556786996982';
            ...
            console.log("\tUNLIMITED MD ONLINE");
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            let msg = `*UNLIMITED MD WELCOME MESSAGE*`;
